...
<?php 
	...
	$sql 	= "select d.codigo,d.titulo,d.empresa as id_empresa,d.imagem from depoimento d where(d.empresa='2')order by d.codigo desc limit ".(($pg-1)*$registros_pagina).",".$registros_pagina;
...
?>
   ...
   <div class="paginacaodepoimentos">
	<?php 
		$sql								= " select count(d.codigo)as total from depoimento d  where(d.empresa='2') order by d.codigo desc ";
		$result 							= mysql_query($sql,$link);
