	...
	<div id="tudo">
        ...
        <div class="linhas" style="background-color:#D1D1D1;">
        	<div class="linhacentro" style="height:112px;">
            	<div id="ERP">E.R.P. MÍDIAMIX SYSTEM</div>
        ...
        <div class="linhas">
        	<div class="linhacentro" style="height:82px;">
              ...
              <div class="espaco" style="width:106px; height:82px;"><a href="./login.php" target="_self" onmouseover="MM_swapImage('Image1','','entrar2.gif',1)" onmouseout="MM_swapImgRestore()"><img src="entrar1.gif" name="Image1" width="106" height="82" border="0" id="Image1" /></a></div>
